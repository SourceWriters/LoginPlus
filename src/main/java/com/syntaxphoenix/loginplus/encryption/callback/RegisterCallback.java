...
public class RegisterCallback extends BukkitRunnable implements EncryptionCallback {
    ...
    public void encryptCallback(String hash) {
        ...
        try {
            ...
            PlayerHelper.sendTitle(player, 20, pluginUtils.getConfig().getTitleTime() * 20, 20, MessagesConfig.title_register_success_title,
                MessagesConfig.title_register_success_subtitle);
