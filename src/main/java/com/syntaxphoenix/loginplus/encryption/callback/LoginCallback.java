...
public class LoginCallback extends BukkitRunnable implements EncryptionCallback {
    ...
    public void validateCallback(boolean validation) {
        ...
        if (validation) {
            ...
            PlayerHelper.sendTitle(player, 20, config.getTitleTime() * 20, 20, MessagesConfig.title_login_success_title,
                MessagesConfig.title_login_success_subtitle);
        } else {
            ...
            if (this.pluginUtils.getLoginManager().tooManyAttempts(player)) {
                ...
                PlayerHelper.sendTitle(player, 20, config.getTitleTime() * 20, 20, MessagesConfig.title_login_failed_title,
